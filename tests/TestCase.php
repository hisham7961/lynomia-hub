...
abstract class TestCase extends BaseTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        // عزلُ خبيئةِ الإعدادات بين الاختبارات: خبيئةُ `array` تبقى في الذاكرةِ عبرَ الاختبارات
        // في العمليّة الواحدة، بينما تُرجِعُ RefreshDatabase جدولَ الإعدادات فقط — فكان
        // `custom.fields` (وسواه) من اختبارٍ سابقٍ يبقى مخبوءاً فيقرؤه اختبارٌ لا يُصفّرها،
        // فتتسرّبُ حقولٌ/قيمٌ بترتيبِ التشغيل (قرعةٌ بين المحرّكين). إسقاطُها هنا يجعلُ كلَّ
        // اختبارٍ يبدأُ بخبيئةٍ باردةٍ يُعيدُ ملأها من قاعدته هو — حتميّةٌ لا ترتيبيّة.
