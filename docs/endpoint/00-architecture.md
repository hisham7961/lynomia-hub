...
| مثبّتا Windows MSI / macOS PKG (هندسةٌ + توقيعٌ صادق) | **IMPLEMENTED (السقالة) — §6**؛ التوقيعُ **NOT_CONFIGURED** صادقاً — راجع 05 |
...
| وضعيّةُ Wi-Fi للشركة (اتصالُ الجهاز نفسِه · قائمةُ SSID معتمدة) | **IMPLEMENTED — §10** (لا مسحَ شبكة؛ مُنعُ القراءة ليس امتثالاً — راجع 04) |
| عقدُ حالةِ الوضعيّة الموسَّع (٦ حالات) | **IMPLEMENTED — §11** (`PostureContract` خادماً + الوكيل — راجع 04) |
