...
<div class="card">
    ...
    @empty
        {{-- **والفراغُ يُعطي البابَ لا الوصف** (عطبُ ما بعد الحذف): من حذف
             آخرَ نموذجٍ له يقف هنا، وأقربُ زرٍّ إليه يقرأ سجلَّ البوّابةِ وحدَه
             — وهو فارغٌ بالضرورةِ بعد الحذف. فيُقرَأ الفراغُ عطلاً. --}}
        <div class="empty">
            <b>لا نموذجَ مُسجَّلٌ بعد.</b>
            <div class="sub">
                <b>والكتالوجُ ما زال كاملاً</b> — فعددُ ما سجّلناه لا يُنقِص منه شيئاً.
            </div>
            @if ($manage ?? true)
                <div style="margin-top:8px">
                    <a class="btn sm" href="{{ route('ai.models.browse', $provider) }}">🔍 تصفَّح الكتالوجَ وأضِف نموذجاً</a>
                </div>
            @endif
        </div>
    @endforelse
