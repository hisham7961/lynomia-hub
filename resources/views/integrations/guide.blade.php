...
<div class="card">
    ...
    <div class="sub" style="line-height:2;margin-bottom:10px">
        <b>الإعداد:</b> الاتصال الافتراضي (الرابط والقاعدة والمستخدم والمفتاح) في
        <a href="{{ route('settings.edit') }}">الإعدادات</a> — والمفتاح <b>مقنّع ومشفّر</b>، ومعه زر «اختبار الاتصال».
        وخوادمُ إضافية — لمشاريعَ لها أودو خاص — مع <b>الدليل التفصيلي خطوةً خطوة</b> وقنواتِ البيع
        (ترنديول، أمازون، نون، المتجر) في <a href="{{ route('integrations.odoo') }}">خوادم أودو</a>.<br>
