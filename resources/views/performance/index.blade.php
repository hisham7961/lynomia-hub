...
{{-- (WP-7.3) الأرقام من قارئ التنفيذ الواحد ExecutionStats: «أُنجز» من ختم الإنجاز لا من آخر تعديل --}}
<div class="sub" style="margin-top:8px">الالتزام = المنجزة قبل موعدها من ذات المواعيد · «أُنجز» من ختم الإنجاز على المهمة، فتعديلٌ لاحقٌ لا يغيّر تاريخَها ولا يقلب النسبة · متوسط الحل من ختم حلّ التذكرة أو آخر تعديلها · تقييم المدير من حقل «التقييم» في ملف الموظف ويخضع لصلاحية الحقل</div>
@endsection
