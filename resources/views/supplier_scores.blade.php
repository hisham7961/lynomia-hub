...
<div class="cards">
    ...
    <div class="stat"><span class="ico">➖</span><b>{{ $t['noHistory'] }}</b><span>بلا تسليم بعد (لا درجة)</span></div>
</div>
...
<div class="card" style="margin-top:12px">
    ...
    <div class="sub" style="line-height:2">
        <b>الدرجة (٠-١٠٠)</b> = الالتزام بالموعد ×٦٠٪ + (١ − نسبة المرتجعات) ×٤٠٪ — نسبة المرتجعات من الأوامر **المسلَّمة فعلاً** لا من كل الأوامر، و**لا درجة لمن لم يُسلَّم منه شيء بعد** (لا نخترع رقماً). الإلغاء لا يُحتسب ضد المورد لأنه غالباً قرارنا.<br>
        ⚠️ <b>«الالتزام بالموعد» تقدير لا قياس دقيق</b>: لا يوجد عمود تاريخ استلام صريح، فنقارن تاريخ آخر تحديث للأمر المستلم بموعد تسليمه — <b>وأي حفظ لاحق للأمر (فوترة أو تحديث دفع) يزيح التاريخ فقد يقلب أمراً في موعده إلى «متأخر»</b>. اقرأه مؤشراً لا حكماً.<br>
