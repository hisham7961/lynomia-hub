...
/** جداول إطار العمل: الطوابير · الكاش · التوكنات · إعادة تعيين كلمة المرور */
return new class extends Migration {
    ...
    {
        foreach (['personal_access_tokens','failed_jobs','job_batches','jobs','cache_locks','cache','sessions','password_reset_tokens'] as $t) {
