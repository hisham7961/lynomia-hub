...
class HubNotification extends Model
{
    ...
    public const MUTEABLE = [
        ...
        // (WP-3.5) أعطالُ التقنية أيضاً: مراقبٌ في إجازةٍ يكتم قناتَه من تفضيلاته
        // بدل أن يهجر الجرسَ كلَّه — والأخطاءُ تبقى مجمَّعةً في مركزها كما هي
        'error' => 'تنبيهات الأعطال التقنية (للمالكين والمراقبين)',
    ];
