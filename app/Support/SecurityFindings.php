...
class SecurityFindings
{
     ...
     * صريح لرموز الفحوص الواحدِ والعشرين (مفاتيحُ row لا أسماءُ الدوال).
     */
    public const SEVERITY_BY_CODE = [
        ...
        // (WP-9.4 · §7.13) مفتاحا الطوارئ المفصولان صارا صفَّين في الوضعية: حالةٌ
        // مقصودةٌ نُسيت مرفوعةً تُعطّل التصديرَ أو سكَّ الرموز صمتاً — انتباهٌ لا إنذار
        'freeze_exports' => 'medium',
        'freeze_tokens'  => 'medium',
    ];
