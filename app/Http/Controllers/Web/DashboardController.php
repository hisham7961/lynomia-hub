...
class DashboardController extends Controller
{
    ...
    protected function pendingLine($user): string
    {
        ...
        if ($bits) return 'لديك ' . implode(' و', $bits) . '.';

        /*
         * «يوم هادئ» فوق قراراتٍ معلّقة **طمأنةٌ كاذبة** (الجولة 1 · وكيل 5: HR
         * قيل لها لا شيءَ عاجلاً وطلبا إجازةٍ بانتظارها): قبل إعلان الهدوء يُسأل
        ...
        try {
            ...
            // الصندوق تعذّر — لا نُعلن هدوءاً زائفاً ولا نكسر الترويسة
        }

        return 'لا شيء عاجل بانتظارك — يوم هادئ 🌿';
    }
}
