...
class PerformanceController extends Controller
{
    ...
    protected function peopleKpis(?\App\Support\TimeRange $range = null)
    {
         ...
         *
         * والقطعُ كان في الوصلةِ وحدَها: `ExecutionStats` يقبل أيَّ مدى، وختمُ
         * الإنجازِ على المهمّةِ مملوءٌ ومُفهرَس، و`hub_range(null)` تقرأ الطلبَ
         * الجاري (‏`TimeRange::fromRequest` تفعل `$r ?? request()`). فسؤالُ «ماذا
         * أُنجز هذا الأسبوع؟» كان **بلا جوابٍ لسطرٍ واحد**، لا لغيابِ بيانٍ ولا
         * محرّك.
         *
         * **ولا يُذكَر اسمُ عمودِ الختمِ هنا نصّاً**: حارسُ «القارئُ واحد»
         * (`EmployeeWorkProfileTest`) يمسح نصَّ هذا الملفِّ ليمنع عدّاداً منافساً،
         * فحتى ذكرُه في تعليقٍ يُسقطه. والصوابُ إعادةُ صياغةِ التعليقِ لا إضعافُ
         * الحارس — فالحسابُ يبقى في `ExecutionStats` وحدَه.
         *
