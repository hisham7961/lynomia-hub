...
class AiModelController extends Controller
{
    ...
    public function discover(AiProvider $provider)
    {
        ...
        return back()
            ...
            /*
             * **وفراغُ السجلِّ ليس فراغَ الكتالوج** (عطبُ ما بعد الحذف).
             *
             * هذا الزرُّ يقرأ **ما سُجِّل عند البوّابةِ** وحدَه. فمن حذف آخرَ
             * نموذجٍ له يرى صفراً هنا **ويقرؤها «لا نماذجَ البتّة»** فيظنّ
             * النظامَ قد تعطّل. والكتالوجُ بابٌ آخرُ لا يتأثّر بعددِ ما سجّلنا.
             */
            ->with('ok', $r['candidates'] === []
                ? 'لا نموذجَ **مسجَّلاً عند البوّابة** لهذا المزوّد — '
                  . 'وهذا لا يعني خلوَّ الكتالوج. افتح «🔍 اكتشافُ النماذجِ وإضافتُها» لتصفّحِه.'
