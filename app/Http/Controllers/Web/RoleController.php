...
class RoleController extends Controller
{
    ...
    public const FLAGS = [
        ...
        // **ولا رايةَ لاستعمالِ المساعدِ بعد** (تصحيحُ المالك · ٥): المحادثةُ
        // لم تُبنَ (المرحلة ٣)، ورايةٌ تُمنَح اليومَ لا تفتح شيئاً — فهي وعدٌ
        // في شاشةِ الأدوار لا قدرة. تُضاف يومَ تُبنى، وتُعرَض حتّى ذلك الحين
        // في سجلِّ القدرات `ai.assistant` بحالةِ DEVELOPMENT صراحةً.
    ];
