...
class PayrollController extends Controller
{
    ...
    {
        // اعتمادُ الرواتبِ الدقيق (payroll.approve) أو رايةُ الاعتمادِ الجامعة (توافقٌ خلفيّ)
        abort_unless(hub_can(auth()->user(), 'payroll', 'approve') || hub_approver(), 403,
            'اعتماد المسيّرات للمالكين وحاملي صلاحية اعتماد الرواتب');
