...
class ReportsController extends Controller
{
    ...
    public function monthlyExport(Request $r)
    {
        ...
        // الوسمُ الزمنيُّ **حقلٌ في الأثر** لا لفظٌ في الاسم (N-7): المالكُ مستثنًى
        // بالتصميم فلا يُوسَم سحبُه فجراً؛ و«متى؟» سؤالٌ يُجاب دائماً — دون أن
        // يصير اسمُ الفعلِ متغيّراً بالساعة.
