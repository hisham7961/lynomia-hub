                ...
                'settings' => ['label' => 'الإعدادات والتكاملات', 'order' => 4, 'destinations' => [
                    ...
                    ['type' => 'admin', 'admin' => 'ai', 'importance' => 'primary', 'route_prefix' => 'ai',
                        'routes' => ['ai.index', 'ai.settings', 'ai.usage', 'ai.diagnostics',
                            'ai.providers.index', 'ai.models.all', 'ai.models.index',
                            'ai.models.browse', 'ai.models.reconcile', 'ai.profiles.index',
                            // (المرحلة ٤) قسما الحوكمة — يُعلَنان كي تعرفهما الفتاتُ والبحثُ ولوحةُ الأوامر
                            'ai.policies.index', 'ai.budgets.index'],
                        'synonyms' => ['ai', 'الذكاء الاصطناعي', 'litellm', 'نماذج', 'مساعد', 'gpt', 'llm',
                            ...
                            'اكتشاف النماذج', 'discover models', 'استيراد نموذج', 'كتالوج النماذج',
                            'مطابقة النماذج', 'reconcile', 'حذف نموذج', 'إزالة نموذج',
                            'سياسات الذكاء', 'حوكمة الذكاء', 'ai policy', 'policies', 'governance',
                            'ميزانية الذكاء', 'ميزانيات', 'budget', 'budgets', 'quota', 'حصة',
                            'سقف الإنفاق', 'تكلفة', 'كلفة', 'usage ledger', 'سجل الاستهلاك']],
