...
return [
    ...
    // ── سجل المنتجات: ملف الطراز ──
    'products' => [
        ['key' => 'datasheet', 'label' => 'ورقة البيانات (Datasheet)', 'multi' => true,
         'hint' => 'مواصفات المصنّع الرسمية للطراز — PDF من موقعه لا صورة شاشة'],
        ['key' => 'photo', 'label' => 'صور المنتج', 'multi' => true,
         'hint' => 'صور الطراز نفسه — صور القطعة بعينها تُرفق على الأصل لا هنا'],
    ],
