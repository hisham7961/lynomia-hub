...
Schedule::command('hub:uptime-check')->everyFiveMinutes();      // فحص حيّ للسيرفرات والمواقع المراقَبة
Schedule::command('hub:quality-snapshot')->dailyAt('23:50');   // درجة جودة البيانات — بها يُقاس ما أُصلح
